from .utils import np, math, operator
...
def analyzeReactions(fout, r1, reactions, inputCalcData, uncerts, expts, calcs, config):
    ...
    # return [r1, len(exptData), expts[r1], selected_mean_expt, math.fabs(selected_mean_expt - expts[r1]), selected_std_expt, uncerts[r1], np.mean(selectedUncertData)]
    # return [r1, len(selectedExptData), expts[r1], selected_mean_expt, math.fabs(selected_mean_expt - expts[r1]), selected_std_expt, uncerts[r1], np.mean(selectedUncertData)]
