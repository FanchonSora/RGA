                ...
                for p3 in range(p2 + 1, sz - 1):
                    ...
                    for p4 in range(p3 + 1, sz):
                        ...
                        if compare2Dicts(rList, pList):
                            ...
                            if compare2Dicts(rBonds, pBonds):
                                rxns.append(printResultSameParallel(reactants=[r1, keys[r2]], products=[keys[p1], keys[p2], keys[p3], keys[p4]]))
        for r3 in range(r2 + 1, sz):
            if keys[r3] == r1:
                continue
            rList = combine2Dicts(atomR1, atomList[r2])
                ...
                for p2 in range(p1 + 1, sz - 1):
                    ...
                    for p3 in range(p2 + 1, sz):
                        ...
                        if compare2Dicts(rList, pList):
                            ...
                            pBonds = combine2Dicts(pBonds, bondP3)
                            if compare2Dicts(rBonds, pBonds):
                                rxns.append(printResultSameParallel(reactants=[r1, keys[r2], keys[r3]], products=[keys[p1], keys[p2], keys[p3]]))
        for r3 in range(r2 + 1, sz - 1):
            if keys[r3] == r1:
                continue
            bondR3 = bonds[r3]
                ...
                for p1 in range(sz - 1):
                    ...
                    for p2 in range(p1 + 1, sz):
                        ...
                        if compare2Dicts(rList, pList):
                            ...
                            pBonds = combine2Dicts(bondP1, bondP2)
                            if compare2Dicts(rBonds, pBonds):
                                rxns.append(printResultSameParallel(reactants=[r1, keys[r2], keys[r3], keys[r4]], products=[keys[p1], keys[p2]]))
    ...
    if noSpecies > 3:
        ...
        for r3 in range(r2 + 1, sz):
            ...
            for p1 in range(sz):
                if p1 == r2 or p1 == r3 or keys[p1] == r1:
                    continue
                coefList = BalanceEq().balanceEq(reactants=[m1, mols[r2], mols[r3]], products=[mols[p1]], atomList=[atomR1, atomList[r2], atomList[r3], atomList[p1]])
